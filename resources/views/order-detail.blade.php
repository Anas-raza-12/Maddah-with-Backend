@extends('layouts.main') @section('title', 'Order-detail') @section('bodyClass', 'orderDetail') @section('content')
<div class="container">
<div class="row">
    
    <div class="col-lg-2">
            <h3 id="My-Profile" class="section-link"> <a href="">My Profile</a></h3>
            <h3 id="address" class="section-link"><a href="">Addresses Book</a></h3>
            <h3 id="Orders" class="section-link"><a href="">My Orders</a></h3>
            <a style="margin-top:3vh;" href="">LOG OUT</a>
        </div>

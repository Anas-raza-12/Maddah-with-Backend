                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <input name="slug" type="text" id="productCodeInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Category slug" value="{{ old('slug') }}" required>
                                @error('slug')
                                <p class="mt-1 text-sm text-red-400 dark:text-zink-200">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            <div class="lg:col-span-2 xl:col-span-12">
                                ...
                                <div id="dropzone" class="px-5 py-8 rounded-md dark:bg-zinc-700 dark:xl:bg-zinc-700 dark:lg:bg-zinc-700 dark:md:bg-zinc-700 dark:disabled:border-zinc-500 border border-dashed border-zinc-500 dark:border-zinc-500 cursor-pointer">
                                    ...
                                    <input name="image" type="file" id="fileInput" class="hidden" multiple accept="image/*" onchange="previewImages()" required>
                                </div>
                                <div id="preview" class="w-30 mt-4 grid grid-cols-2 gap-4"></div>
                            </div>
                            <div class="lg:col-span-2 xl:col-span-12">
                                @error('image')

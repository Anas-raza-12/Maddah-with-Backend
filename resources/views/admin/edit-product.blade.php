                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <input type="text" name="slug" value="{{ old('slug', $product->slug) }}" id="productCodeInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Product Code" value="" required>
                                @error('slug')
                                <p class="mt-1 text-sm text-red-400 dark:text-zink-200">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            <div class="xl:col-span-4">
                                ...
                                <input type="number" name="quantity" value="{{ old('quantity', $product->quantity) }}" id="qualityInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Quantity" required>
                                @error('quantity')
                                <p class="mt-1 text-sm text-red-400 dark:text-zink-200">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-4">
                                ...
                                <input type="number" name="regular_price" value="{{ old('regular_price', $product->regular_price) }}" id="productPrice" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="$0.00" required>
                                @error('regular_price')
                                <p class="mt-1 text-sm text-red-400 dark:text-zink-200">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            <div class="xl:col-span-4">
                                ...
                                <input type="number" name="sale_price" value="{{ old('sale_price', $product->sale_price) }}" id="productPrice" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="$0.00">
                                @error('sale_price')
                                <p class="mt-1 text-sm text-red-400 dark:text-zink-200">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            <div class="lg:col-span-2 xl:col-span-12">
                                ...
                                <div id="productImagePreviewContainer" class="mt-4 grid grid-cols-3 gap-4">
                                    @foreach ($productImages as $image)
                                        <div class="relative w-28 h-28">
                                            <img src="{{ asset('uploads/products') . '/' . $image }}" class="w-full h-full object-cover rounded-md" alt="{{ $image }}">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="card sticky top-[calc(theme('spacing.header')_*_1.3)]">
                    <div class="card-body">
                        ...
                        <div id="imagePreviewContainer" class="px-5 py-8 rounded-md bg-sky-50 dark:bg-zinc-700 dark:md:bg-zinc-700 dark:lg:bg-zinc-700">
                            ...
                            <img id="defaultImage" src="{{ asset('uploads/products/'. $product->featured_image) }}" alt="Upload Featured Image" class="block mx-auto h-44">
                            @endif

...
<head>
    ...
    <meta charset="utf-8">
    <title>@yield('title') | MADDAH - Admin & Dashboard</title>
    ...
    <!-- Layout config Js -->
    <script src="{{ asset('tailwick/assets/js/layout.js') }}"></script>
    <!-- Icons CSS -->
...
<body class="flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public">
    ...
    {{-- <script src="{{ asset('tailwick/assets/js/pages/auth-login.init.js') }}"></script> --}}

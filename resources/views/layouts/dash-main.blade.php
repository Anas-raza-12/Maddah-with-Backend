...
<head>
    ...
    <meta charset="utf-8">
    <title>Maddah - Admin & Dashboard</title>
    ...
    <link rel="stylesheet" href="{{ asset('tailwick/assets/css/tailwind2.css')}}">
</head>
        ...
        <footer class="ltr:md:left-vertical-menu rtl:md:right-vertical-menu group-data-[sidebar-size=md]:ltr:md:left-vertical-menu-md group-data-[sidebar-size=md]:rtl:md:right-vertical-menu-md group-data-[sidebar-size=sm]:ltr:md:left-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:md:right-vertical-menu-sm absolute right-0 bottom-0 px-4 h-14 group-data-[layout=horizontal]:ltr:left-0  group-data-[layout=horizontal]:rtl:right-0 left-0 border-t py-3 flex items-center dark:border-zink-600">
            <div class="group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl w-full">
                <div class="grid items-center grid-cols-1 text-center lg:grid-cols-2 text-slate-400 dark:text-zink-200 ltr:lg:text-left rtl:lg:text-right">
                    <div>
                        <script>document.write(new Date().getFullYear())</script> © Rootlet Solutions.
                    </div>
                    <div class="hidden lg:block">
                        <div class="ltr:text-right rtl:text-left">
                            Design & Develop by Muhammad Zubair
                        </div>
                    </div>
                </div>
            </div>
...
<script src='{{ asset('tailwick/assets/libs/choices.js/public/assets/scripts/choices.min.js') }}'></script>
<script src="{{ asset('tailwick/assets/libs/%40popperjs/core/umd/popper.min.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/tippy.js/tippy-bundle.umd.min.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/simplebar/simplebar.min.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/prismjs/prism.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/lucide/umd/lucide.js') }}"></script>
<script src="{{ asset('tailwick/assets/js/tailwick.bundle.js') }}"></script>
<!--apexchart js-->
<script src="{{ asset('tailwick/assets/libs/apexcharts/apexcharts.min.js') }}"></script>

<!--dashboard ecommerce init js-->
<script src="{{ asset('tailwick/assets/js/pages/dashboards-ecommerce.init.js') }}"></script>

<!-- list js-->
<script src="{{ asset('tailwick/assets/libs/list.js/list.min.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/list.pagination.js/list.pagination.min.js') }}"></script>
<script src="{{ asset('tailwick/assets/libs/flatpickr/flatpickr.min.js') }}"></script>

<!-- listjs init -->
<script src="{{ asset('tailwick/assets/js/pages/listjs.init.js') }}"></script>

<!-- add product js -->
@yield('addproductscript')

<!-- App js -->
<script src="{{ asset('tailwick/assets/js/app.js') }}"></script>
